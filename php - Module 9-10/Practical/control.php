		     ...
		     
			 {
				...
				case '/addcustomer':
					if(isset($_REQUEST['submit']))
					{
						...
						$arr=array("UNM"=>$UNM,"pass"=>$pass,"name"=>$name,"email"=>$email,"address"=>$address,"phone"=>$phone,"accounttype"=>$accounttype,"accountno"=>$accountno,"balance"=>$balance,"updated"=>$updated,"delated"=>$delated);
